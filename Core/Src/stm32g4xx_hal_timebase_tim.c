...
/**
  * @brief  This function configures the TIM20 as a time base source.
...
/**
  ...
  * @note   Disable the tick increment by disabling TIM20 update interrupt.
  * @param  None
  * @retval None
  */
...
/**
  ...
  * @note   Enable the tick increment by Enabling TIM20 update interrupt.
  * @param  None
  * @retval None
  */
